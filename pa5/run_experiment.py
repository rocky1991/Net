...
s
			...
			input('Please log in server(Responder and start pulling message,\n Run "python3 pull_msg.py q5_responder1.log True messages2"\nEnter to continue')
			input('Please log in second responder and start pulling messages\n Run "python3 pull_msg.py q5_responder2.log False None')
			...
			iinput('Please log in server(Responder and start pulling message,\n Run "python3 pull_msg.py q10_responder1.log True messages2"\nEnter to continue')
			input('Please log in second responder and start pulling messages\n Run "python3 pull_msg.py q10_responder2.log False None')
