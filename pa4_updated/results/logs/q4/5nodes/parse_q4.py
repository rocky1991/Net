with open('local_produce_5nodes.log', 'U') as file:
	l = file.read()
	# print(line)
	while 'Produce message:(key=' in l:
		l=l.replace('Produce message:(key=','')
	while ') to topic: topic5 at time:' in l:
		l=l.replace(') to topic: topic5 at time:',',')
	while ' msg_size=' in l:
...
with open('responder1_topic5_4.log','U') as file:
	line = file.read()
	...
	while ") from topic: topic5 at time:" in line:
		line = line.replace(") from topic: topic5 at time:",',')
...
# 		file.write(new_line)
with open('responder2_topic5_4.log','U') as file:
	line = file.read()
	while "Receive message: (key=b'" in line:
		line=line.replace("Receive message: (key=b'",'')
	while ') from topic: topic5 at time:' in line:
...
with open('responder3_topic5_4.log','U') as file:
	line = file.read()
	while "Receive message: (key=b'" in line:
		line=line.replace("Receive message: (key=b'",'')
	while ') from topic: topic5 at time:' in line:
...
with open('responder4_topic5_4.log','U') as file:
	line = file.read()
	while "Receive message: (key=b'" in line:
		line=line.replace("Receive message: (key=b'",'')
	while ') from topic: topic5 at time:' in line:
...
with open('responder5_topic5_4.log','U') as file:
	line = file.read()
	while "Receive message: (key=b'" in line:
		line=line.replace("Receive message: (key=b'",'')
	while ') from topic: topic5 at time:' in line:
